...
def main(dataset='train', n_sent=60):
    ...
    train = pickle.load(open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data/train_test_v2/X_train.pkl','rb'))
    train_labels = pickle.load(open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data/train_test_v2/y_train.pkl','rb'))
    train_labels = train_labels.label
    train_publishers = train.source_name
    train_sent = open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data_tsv/train_sent/dev.tsv').readlines()
    train_pred = open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data_tsv/train_sent/predictions_editorial-claim-premise-bert.txt').readlines()
    train_news_counts, train_op_counts = get_counts_per_article_type(train_sent, train_pred, train_labels, train_publishers, n_sent)
    
    dev = pickle.load(open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data/train_test_v2/X_test.pkl','rb'))
    dev_labels = pickle.load(open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data/train_test_v2/y_test.pkl','rb'))
    dev_labels = dev_labels.label
    dev_publishers = dev.source_name
    dev_sent = open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data_tsv/dev_sent/dev.tsv').readlines()
    dev_pred = open('/Users/tariq/Documents/Data/Bloomberg_Editorial_Classifier/data_tsv/dev_sent/predictions_editorial-claim-premise-bert.txt').readlines()
